...
export default function Topbar({ appTitle }) {
  return (
    <div className="sticky top-0 z-50"> {/* Added sticky positioning */}
      <nav className='bg-white border-gray-200 dark:bg-gray-900 shadow-md'> {/* Added shadow for better visual separation */}
